                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('tasks.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="naziv_rada" id="naziv_rada" value="{{ old('naziv_rada') }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="naziv_rada_engleski" id="naziv_rada_engleski" value="{{ old('naziv_rada_engleski') }}" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="zadatak_rada" id="zadatak_rada" rows="6" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('zadatak_rada') }}</textarea>
                            @error('zadatak_rada')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
