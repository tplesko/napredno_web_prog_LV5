        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="flex gap-2">
                    ...
                    class="px-3 py-2 text-sm {{ app()->getLocale() === 'hr' ? 'font-bold text-gray-900' : 'text-gray-600' }}">
                        HR
                    </a>
                    <span class="text-gray-400">|</span>
                    <a href="{{ route('language.switch', 'en') }}" 
                    class="px-3 py-2 text-sm {{ app()->getLocale() === 'en' ? 'font-bold text-gray-900' : 'text-gray-600' }}">
                        EN
                    </a>
                </div>
            </div>
